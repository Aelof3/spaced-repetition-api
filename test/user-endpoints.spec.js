    ...
    describe(`Given a valid user`, () => {
      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          total_score: 0,
          words: [
            { original: 'yeej tsis', translation: 'never' },
            { original: 'mus', translation: 'gonna' },
            { original: 'muab', translation: 'give' },
            { original: 'koj', translation: 'you' },
            { original: 'up', translation: 'up' },
            { original: 'cia', translation: 'let' },
            { original: 'lawm os', translation: 'down' },
            { original: 'khiav', translation: 'run' },
            { original: 'ib ncig', translation: 'around' },
            { original: 'thiab', translation: 'and' },
            { original: 'suab puam', translation: 'desert' }
          ],
        };
